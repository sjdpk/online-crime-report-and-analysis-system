<?php
    ...
    if(!$conn)
    {
        ...
        $result=mysqli_query($conn,"SELECT * FROM subadmin_details where batch_no='$subadmin_batchno' ");
        ...
        if(isset($_POST["submit"])){
          ...
          $result1=mysqli_query($conn,"SELECT password FROM subadmin_details where batch_no='$subadmin_batchno' ");
          ...
          if($password1==$password2){
              ...
              if($password0==$password){
                ...
                $Query="UPDATE `subadmin_details` SET `password`='$password1'   WHERE batch_no='$subadmin_batchno' ";
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled="" placeholder="CitizenShip Number" value="<?php echo($subadmin_batchno)?>">
                      </div>
                    </div>
