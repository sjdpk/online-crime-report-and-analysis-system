...
$mail->From = "<your-from-mail-address>";
    ...
    <div class="row justify-content-center">
      <div class="col-md-12 bg-light rounded" >
        <div  style="border-radius:10px;height: 100px;background-color: #6340bc ">
          <h1 class="text-center text-white" style="padding: 25px;">Contact Admin</h1>
        </div>
        ...
        <form action="" method="post" id="form-box" class="p-2">
          ...
          <div class="form-group input-group">
            ...
            <!-- <select style="width: 90%;" name="email">
              <option>&nbsp;&nbsp;select Admin Email</option>
              <option>&nbsp;Admin1@gmail.com</option>
              <option>&nbsp;Admin2@gmail.com</option>
              <option>&nbsp;Admin3@gmail.com</option>
              <option>&nbsp;Admin4@gmail.com</option>
              <option>&nbsp;Admin5@gmail.com</option>
            </select> -->
          </div>
          <div class="form-group input-group">
            <div class="input-group-prepend">
