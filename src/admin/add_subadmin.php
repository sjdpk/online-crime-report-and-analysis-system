...
if(isset($_POST["submit"])){
	...
	$sql = "INSERT INTO subadmin_details(batch_no,first_name,middle_name,last_name,contact_no,username,email,password,type,datetime)
 ...
 // 	move_uploaded_file($_FILES["Image"]["tmp_name"],$Target);
 		...
 		$_SESSION["SuccessMessage"]="Your Registration Added Successfully  ! ";
 		  ...
 		  echo "<h3 style='color:red;background-color:black;text-align:center'>Sub-Admin Registration Added Successfully  ! </h3>";
	} else {
			...
			<div class="col-8"> 
				...
				<div class="card" style="width: 35rem;">
				  <div class="bg-success" style="border-radius:10px;height: 100px;">
					<h1 class="text-center text-white" style="padding: 25px;">Sub-Admin Register</h1>
				</div>
